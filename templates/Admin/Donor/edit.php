	...
	<div class="col-2 text-end">
		<div class="dropdown mx-3 mt-2">
            ...
            <?= $this->Form->postLink(
                ...
                ['confirm' => __('Are you sure you want to delete # {0}?', $donor->id), 'class' => 'dropdown-item', 'escapeTitle' => false]
            ) ?>
            <?= $this->Html->link(__('List Donor'), ['action' => 'index'], ['class' => 'dropdown-item', 'escapeTitle' => false]) ?>
				</div>
		</div>
    </div>
</div>
    ...
    <div class="card-body text-body-secondary">
            ...
            <fieldset>
                <legend><?= __('Edit Donor') ?></legend>
                    ...
                    <?php echo $this->Form->control('bloodtype'); ?>
