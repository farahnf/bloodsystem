    ...
    <div class="px-0">
        <ul class="list-unstyled components">
            ...
            <?php if ($this->Identity->isLoggedIn()) { ?>
                ...
                <li class="menu-item <?= $c_name == 'Donation' && $a_name == 'index' ? 'active' : '' ?>">
                    <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-droplet"></i> Donation'), ['controller' => 'Donation', 'action' => 'index', 'prefix' => false], ['class' => 'menu-link', 'escape' => false]) ?>
                </li>

                <li class="menu-item <?= $c_name == 'Donor' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-id-card"></i> Donor'), ['controller' => 'Donor', 'action' => 'add', 'prefix' => false], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
                ...
                <?php if ($this->Identity->isLoggedIn() && $this->Identity->get('user_group_id') == '1') { ?>
                    ...
                    <li class="menu-item <?= $c_name == 'Donation' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-droplet"></i> Donation'), ['prefix' => 'Admin', 'controller' => 'Donation', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>

                    <li class="menu-item <?= $c_name == 'Donor' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-id-card"></i> Donor'), ['prefix' => 'Admin', 'controller' => 'Donor', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
                    
                    <li class="menu-item <?= $c_name == 'Blood' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-syringe"></i> Blood'), ['prefix' => 'Admin', 'controller' => 'Blood', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
